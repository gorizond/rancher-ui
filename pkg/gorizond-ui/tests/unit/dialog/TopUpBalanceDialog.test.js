...
describe('TopUpBalanceDialog', () => {
  ...
  describe('submit functionality', () => {
    ...
    it('should throw error when amount is empty', async () => {
      ...
      await expect(component.submit()).rejects.toThrow('Amount must be greater than 0');
    });
  ...
  describe('form creation', () => {
    ...
    it('should create hidden inputs for all data fields', () => {
      ...
      expect(formData.inputs).toHaveLength(3);
  ...
  describe('UI text', () => {
    it('should return correct banner text', () => {
      ...
      expect(bannerText).toBe('Replenishment of the balance for test-namespace / test-billing');
    });
